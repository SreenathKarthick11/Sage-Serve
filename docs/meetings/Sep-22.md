...
- [ ] Google Slides is used for the presentation. [Google Slide Link](https://docs.google.com/presentation/d/1nEfR7WGiZX0B1zEJosX6CK1tyWVI0BmDf5KjZJzLkqY/edit?slide=id.p#slide=id.p)
- [ ] Answers for the below [questions](#questions)
...
> **ANSWER**
> HMM is better, but it is slow compared to ARIMA for forcasting.
